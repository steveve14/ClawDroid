...
- **녹음 안전 정지**: 무응답/장시간 녹음 자동 중지, 정지 버튼 즉시 취소
...
### 5. ChannelDetailFragment — 채널 상세

**기능**:
- **연결 상태 관리**: 연결/연결 해제, 오류 상태 표시
- **DM 페어링**: 5분 TTL 페어링 코드 생성
- **채널 페르소나**: 채널별 System Prompt 저장, 외부 채널 AI 응답에 우선 적용
- **채널 삭제**: 연결 해제 후 채널 설정 제거

### 6. SettingsFragment — 설정
