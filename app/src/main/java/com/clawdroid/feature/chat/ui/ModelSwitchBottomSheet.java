...
public class ModelSwitchBottomSheet extends BottomSheetDialogFragment {
    ...
    private OnAddModelClickListener addModelListener;
    ...
    public void setOnAddModelClickListener(OnAddModelClickListener listener) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnAddModel = view.findViewById(R.id.btnAddModel);
        if (btnAddModel != null) {
            btnAddModel.setOnClickListener(v -> {
                dismiss();
                if (addModelListener != null) {
                    addModelListener.onAddModelClicked();
                }
            });
        }
    }
