...
import com.clawdroid.core.ai.AvailableModelInfo;
...
import com.clawdroid.app.databinding.FragmentChatBinding;
            ...
            viewModel.getAvailableModels()
                ...
                .subscribe(
                    availableModels -> {
                        ...
                        for (AvailableModelInfo info : availableModels) {
                            options.add(new ModelSwitchBottomSheet.ModelOption(
                        ...
                        sheet.setOnAddModelClickListener(() ->
                                Navigation.findNavController(requireView())
                                        .navigate(R.id.action_chat_to_settings));
                        sheet.show(getChildFragmentManager(), "model_switch");
                    },
                    e -> com.google.android.material.snackbar.Snackbar.make(
                            binding.getRoot(), "모델 목록을 불러올 수 없습니다.",
