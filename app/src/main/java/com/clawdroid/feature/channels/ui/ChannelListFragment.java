...
import com.clawdroid.app.databinding.FragmentChannelListBinding;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ChannelAdapter(channel -> {
            ...
            Navigation.findNavController(view)
                    .navigate(R.id.action_channelList_to_channelDetail, args);
        });
        ...
        binding.fabAddChannel.setOnClickListener(v ->
                Navigation.findNavController(view)
                        .navigate(R.id.action_channelList_to_channelAdd)
        );
    }
